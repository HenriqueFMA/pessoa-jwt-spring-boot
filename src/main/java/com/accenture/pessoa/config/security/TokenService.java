 ...
 * O segredo é configurado via application.properties (api.security.token.secret).
 */
@Service
public class TokenService {
     ...
     * O token expira em 2 horas (fuso horário -03:00).
     */
    ...
    /**
     * Valida o token JWT e retorna o subject (login do usuário).
